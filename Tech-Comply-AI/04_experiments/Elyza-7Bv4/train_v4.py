"""
Elyza-7B v4 ファインチューニングスクリプト
- システムメッセージを学習データのフォーマットに統一
- 修正案の空白問題に対応
"""
...
parser = argparse.ArgumentParser(description="Fine-tune ELYZA with QLoRA (v4)")
parser.add_argument("--config_path", type=str, default="./config_v4.yaml")
args = parser.parse_args()

config = load_config(args.config_path)

print("=" * 70)
print("Elyza-7B v4 ファインチューニング")
print("=" * 70)
print(f"Model: {config['model_name']}")
print(f"Output: {config['new_model_name']}")
print(f"Data: {config['train_file_path']}")
print("=" * 70)
...
print("✓ 準備完了")
print("\n--- v4の改善点 ---")
print("1. システムメッセージを学習データと完全一致")
print("2. 修正案の空白問題に対応（train_data_fixed.jsonl使用）")
print("3. LoRAランク: 16（過学習防止）")
print("4. 学習率: 2e-4（効率的な学習）")
print("5. 評価: step単位で細かく監視")

# 学習実行
print("\n[5/7] 学習を開始します...")
print("=" * 70)
print("推定時間: T4 6-10時間, A100 2-4時間")
print("=" * 70)
...
print("✓ 修正案が必ず出力される")
print("✓ フォーマットの一貫性が向上")
print("✓ 過学習を抑制（LoRAランク16）")
print("\n次のステップ:")
print(f"python inference_v4.py --adapter_path {save_path}")
print("=" * 70)
